...
function runner.env_override(m)
  local live = runner.getenv("PARKINGSTGALLEN_TEST_LIVE")
  local override = runner.getenv("PARKINGSTGALLEN_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("PARKINGSTGALLEN_TEST_EXPLAIN")
