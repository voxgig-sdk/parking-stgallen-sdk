...
function runner.env_override(m)
  local live = runner.getenv("PARKING_STGALLEN_TEST_LIVE")
  local override = runner.getenv("PARKING_STGALLEN_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("PARKING_STGALLEN_TEST_EXPLAIN")
