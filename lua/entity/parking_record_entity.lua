...
local ParkingRecordEntity = {}
ParkingRecordEntity.__index = ParkingRecordEntity


function ParkingRecordEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, ParkingRecordEntity)
  self._name = "parking_record"
  self._client = client
...
function ParkingRecordEntity:get_name()
  return self._name
end


function ParkingRecordEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return ParkingRecordEntity.new(self._client, opts)
end
...
function ParkingRecordEntity:mark_deleted()
  self._deleted = true
end


function ParkingRecordEntity:deleted()
  return true == self._deleted
end


function ParkingRecordEntity:data_set(args)
  if args ~= nil then
...
function ParkingRecordEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function ParkingRecordEntity:match_set(args)
  if args ~= nil then
...
function ParkingRecordEntity:match_get()
...
function ParkingRecordEntity:stream(action, args, callopts)
...
function ParkingRecordEntity:_run_op(ctx, post_done)
  local utility = self._utility
