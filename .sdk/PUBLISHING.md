...
|---|---|---|
| `ts/` | @voxgig-sdk/parking-stgallen-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/parking-stgallen-sdk \
      --repository voxgig-sdk/parking-stgallen-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/parking-stgallen-sdk` shows it, and
`npm trust revoke @voxgig-sdk/parking-stgallen-sdk --id=<id>` removes it.
