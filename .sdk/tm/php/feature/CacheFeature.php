...
// ParkingStgallen SDK cache feature
...
class ParkingStgallenCacheFeature extends ParkingStgallenBaseFeature
{
    ...
    private function _through(ParkingStgallenContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
