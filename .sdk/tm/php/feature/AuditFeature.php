...
// ParkingStgallen SDK audit feature
...
class ParkingStgallenAuditFeature extends ParkingStgallenBaseFeature
{
    ...
    private function _emit(ParkingStgallenContext $ctx, string $outcome): void
    {
