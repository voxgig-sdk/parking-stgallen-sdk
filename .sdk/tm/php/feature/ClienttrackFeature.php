...
// ParkingStgallen SDK clienttrack feature
...
class ParkingStgallenClienttrackFeature extends ParkingStgallenBaseFeature
{
    ...
    public function PostConstruct(ParkingStgallenContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'ParkingStgallen-SDK';
