...
// ParkingStgallen SDK streaming feature
...
class ParkingStgallenStreamingFeature extends ParkingStgallenBaseFeature
{
    ...
    private function _iterate(ParkingStgallenResult $result): \Generator
    {
    ...
    private function _streamable(ParkingStgallenContext $ctx): bool
    {
