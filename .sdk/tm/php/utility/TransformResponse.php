...
// ParkingStgallen SDK utility: transform_response

require_once __DIR__ . '/../core/Helpers.php';

class ParkingStgallenTransformResponse
{
    public static function call(ParkingStgallenContext $ctx): mixed
    {
        ...
        $transform = ParkingStgallenHelpers::to_map(\Voxgig\Struct\Struct::getprop($point, 'transform'));
        if (!$transform) {
            return null;
        }
