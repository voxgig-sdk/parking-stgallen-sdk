...
// ParkingStgallen SDK utility: result_basic

class ParkingStgallenResultBasic
{
    public static function call(ParkingStgallenContext $ctx): ?ParkingStgallenResult
    {
        ...
        if ($result && $response) {
            ...
            if ($result->status >= 400) {
                ...
                if ($result->err) {
                    $prev = ($result->err instanceof ParkingStgallenError) ? $result->err->msg : (string)$result->err;
