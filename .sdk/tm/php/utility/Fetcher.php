...
// ParkingStgallen SDK utility: fetcher

class ParkingStgallenFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; ParkingStgallenSDK/1.0)';
    ...
    public static function call(ParkingStgallenContext $ctx, string $fullurl, array $fetchdef): array
    {
