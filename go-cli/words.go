...
func registerSDKWords(r *eng.Registry, client *sdk.ParkingStgallenSDK) {
...
func runOp(client *sdk.ParkingStgallenSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
