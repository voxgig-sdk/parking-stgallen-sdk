...
AQL-driven CLI and REPL for the ParkingStgallen SDK. Positional arguments are
...
```sh
go build -o parking-stgallen-cli ./...
```
...
./parking-stgallen-cli load 1 parking_record
./parking-stgallen-cli load '{id:1}' parking_record
