// Command ParkingStgallen-mcp is an MCP server exposing the ParkingStgallen
// SDK as MCP tools.
//
// Two tools are registered:
//
//	ParkingStgallen_list  — list records of an entity
//	ParkingStgallen_load  — load a single record of an entity
//
