...
type Args struct {
	Entity string         `json:"entity" jsonschema:"parking_record"`
	Query  map[string]any `json:"query,omitempty" jsonschema:"optional match map e.g. {\"id\":1} for load, omit for list"`
}

func registerTools(server *mcp.Server, client *sdk.ParkingStgallenSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "parking-stgallen_list",
		Description: "List records from ParkingStgallen. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "parking-stgallen_load",
		Description: "Load a single record from ParkingStgallen. " +
...
func runOp(client *sdk.ParkingStgallenSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.ParkingStgallenSDK, name string) (sdk.ParkingStgallenEntity, error) {
	switch strings.ToLower(name) {
	case "parking_record":
		return client.ParkingRecord(nil), nil
