...
type ParkingStgallenSDK struct {
	Mode     string
...
func (sdk *ParkingStgallenSDK) OptionsMap() map[string]any {
...
func (sdk *ParkingStgallenSDK) GetUtility() *Utility {
	return CopyUtility(sdk.utility)
}

func (sdk *ParkingStgallenSDK) GetRootCtx() *Context {
	return sdk.rootctx
}

func (sdk *ParkingStgallenSDK) Prepare(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *ParkingStgallenSDK) Direct(fetchargs map[string]any) (map[string]any, error) {
...
func (sdk *ParkingStgallenSDK) opAllowed(op string) bool {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return strings.Contains(allowOp, op)
}

func (sdk *ParkingStgallenSDK) opDenied(op string) map[string]any {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return map[string]any{
		"ok": false,
		"err": fmt.Errorf("ParkingStgallenSDK: %s: operation not allowed by"+
...
// gate by passing it.
func (sdk *ParkingStgallenSDK) rawRequest(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *ParkingStgallenSDK) Graphql(
	...
	if 0 < len(errors) {
		...
		res["ok"] = false
		res["err"] = fmt.Errorf("ParkingStgallenSDK: graphql: %s", msg)
		res["graphql"] = errors
	}
...
func TestSDK(testopts map[string]any, sdkopts map[string]any) *ParkingStgallenSDK {
	...
	sdk := NewParkingStgallenSDK(sdkopts)
	sdk.Mode = "test"
