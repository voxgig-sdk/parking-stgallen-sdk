...
from parkingstgallen_sdk.utility import register

# Load features
from parkingstgallen_sdk.feature.base_feature import ParkingStgallenBaseFeature
from parkingstgallen_sdk.features import _has_feature, _make_feature
...
class ParkingStgallenSDK:
    ...
    def __init__(self, options=None):
        ...
        utility = ParkingStgallenUtility()
    ...
    def get_utility(self):
        return ParkingStgallenUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("ParkingStgallenSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def ParkingRecord(self, data=None) -> "ParkingRecordEntity":
        ...
        from parkingstgallen_sdk.entity.parking_record_entity import ParkingRecordEntity
