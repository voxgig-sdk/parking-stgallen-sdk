# ParkingStgallen SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions ParkingStgallenSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both ParkingStgallenSDK(...) and ParkingStgallenSDK.test(...) become
#      ParkingStgallenSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "parkingstgallen_sdk"
_SDK_CLASS = "ParkingStgallenSDK"
