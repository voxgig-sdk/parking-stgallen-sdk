...
#      offline in seeded test mode (ParkingStgallenSDK.test) against the real
...
class ReadmeExamplesTest < Minitest::Test
  ...
  SDK = File.join(__dir__, "..", "ParkingStgallen_sdk.rb")
  SDK_CLASS = "ParkingStgallenSDK"
