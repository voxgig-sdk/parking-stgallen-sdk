...
// ParkingStgallen SDK utility: graphql
//
...
class ParkingStgallenGraphql
{
    ...
    // equivalent.
    public static function body(ParkingStgallenContext $ctx): mixed
    {
    ...
    public static function errors(ParkingStgallenContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
