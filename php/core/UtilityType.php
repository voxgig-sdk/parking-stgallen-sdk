...
// ParkingStgallen SDK utility type

class ParkingStgallenUtility
{
    ...
    public static function copy(ParkingStgallenUtility $src): ParkingStgallenUtility
    {
        $u = new ParkingStgallenUtility();
        $u->clean = $src->clean;
        $u->done = $src->done;
