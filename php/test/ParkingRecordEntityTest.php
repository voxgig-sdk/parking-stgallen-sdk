...
class ParkingRecordEntityTest extends TestCase
{
    ...
    public function test_basic_flow(): void
    {
        ...
        if (!empty($setup["synthetic_only"])) {
            $this->markTestSkipped("live entity test uses synthetic IDs from fixture — set PARKINGSTGALLEN_TEST_PARKING_RECORD_ENTID JSON to run live");
            return;
        }
        $client = $setup["client"];
...
function parking_record_basic_setup($extra)
{
    ...
    $entid_env_raw = getenv("PARKINGSTGALLEN_TEST_PARKING_RECORD_ENTID");
