...
// ParkingStgallen SDK struct utility test
//
...
class StructUtilityTest extends TestCase
{
    ...
    {
        if (self::$run === null) {
            $runner = ParkingStgallenOmni::makeStructRunner(
        ...
        $this->runsection(
            ...
            function ($input) {
                ...
                if (is_object($store) && $haspath && Struct::undef() !== $val) {
                    ...
                    if (json_encode(ParkingStgallenOmni::structfix($now, Struct::undef()))
                        !== json_encode(ParkingStgallenOmni::structfix($val, Struct::undef()))) {
