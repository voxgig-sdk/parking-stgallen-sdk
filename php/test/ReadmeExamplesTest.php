...
// ParkingStgallen SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (ParkingStgallenSDK::test)
...
{
    private const SDK_CLASS = 'ParkingStgallenSDK';
    ...
    private const SDK_BASE = 'parkingstgallen_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../parkingstgallen_sdk.php';
        foreach ($this->phpBlocks() as $blk) {
