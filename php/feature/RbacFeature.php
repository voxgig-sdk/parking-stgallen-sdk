...
// ParkingStgallen SDK rbac feature
...
class ParkingStgallenRbacFeature extends ParkingStgallenBaseFeature
{
    ...
    private function _required(ParkingStgallenContext $ctx): ?string
    {
    ...
    private function _reject(ParkingStgallenContext $ctx, string $required): void
    {
    ...
    private function _track(ParkingStgallenContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
