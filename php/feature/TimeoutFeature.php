...
// ParkingStgallen SDK timeout feature
...
class ParkingStgallenTimeoutFeature extends ParkingStgallenBaseFeature
{
    ...
    private function _with_timeout(ParkingStgallenContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(ParkingStgallenContext $_ctx, float $ms): void
    {
        $client = $this->client;
