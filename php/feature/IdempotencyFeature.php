...
// ParkingStgallen SDK idempotency feature
...
class ParkingStgallenIdempotencyFeature extends ParkingStgallenBaseFeature
{
    ...
    private function _mutating(ParkingStgallenContext $ctx): bool
    {
