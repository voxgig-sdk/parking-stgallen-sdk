...
// ParkingStgallen SDK ratelimit feature
...
class ParkingStgallenRatelimitFeature extends ParkingStgallenBaseFeature
{
    ...
    private function _acquire(ParkingStgallenContext $ctx): void
    {
    ...
    private function _track(ParkingStgallenContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
