...
// ParkingStgallen SDK telemetry feature
...
class ParkingStgallenTelemetryFeature extends ParkingStgallenBaseFeature
{
    ...
    private function _close(ParkingStgallenContext $ctx, bool $ok): void
    {
