...
// ParkingStgallen SDK proxy feature
...
class ParkingStgallenProxyFeature extends ParkingStgallenBaseFeature
{
    ...
    public function init(ParkingStgallenContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (ParkingStgallenContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
