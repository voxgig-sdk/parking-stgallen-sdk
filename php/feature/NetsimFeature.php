...
// ParkingStgallen SDK netsim feature
...
class ParkingStgallenNetsimFeature extends ParkingStgallenBaseFeature
{
    ...
    private function _simulate(ParkingStgallenContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(ParkingStgallenContext $ctx, array $applied): void
    {
        $client = $this->client;
