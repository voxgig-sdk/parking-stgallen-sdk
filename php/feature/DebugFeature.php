...
// ParkingStgallen SDK debug feature
...
class ParkingStgallenDebugFeature extends ParkingStgallenBaseFeature
{
    ...
    private function _finish(ParkingStgallenContext $ctx, bool $ok): void
    {
