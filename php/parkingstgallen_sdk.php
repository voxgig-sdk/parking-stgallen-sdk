...
class ParkingStgallenSDK
{
    ...
    public function __construct(array $options = [])
    {
        ...
        $feature_opts = ParkingStgallenHelpers::to_map(Struct::getprop($this->options, "feature"));
        if ($feature_opts) {
            $featureorder = Struct::getpath($this->options, "__derived__.featureorder");
            if (is_array($featureorder)) {
                foreach ($featureorder as $fname) {
                    $fopts = ParkingStgallenHelpers::to_map($feature_opts[$fname] ?? null);
                    if ($fopts && isset($fopts["active"]) && $fopts["active"] === true) {
                        ...
                        if (!ParkingStgallenFeatures::has_feature($fname)) {
                        ...
                        ($utility->feature_add)($this->_rootctx, ParkingStgallenFeatures::make_feature($fname));
                    }
                }
            }
        }
    ...
    {
        return ParkingStgallenUtility::copy($this->_utility);
    }
    ...
    public function prepare(array $fetchargs = []): mixed
    {
        ...
        $ctrl = ParkingStgallenHelpers::to_map(Struct::getprop($fetchargs, "ctrl")) ?? [];
        ...
        $params = ParkingStgallenHelpers::to_map(Struct::getprop($fetchargs, "params")) ?? [];
        $query = ParkingStgallenHelpers::to_map(Struct::getprop($fetchargs, "query")) ?? [];
    ...
    private function op_denied(string $op): array
    {
        ...
        return [
            "ok" => false,
            "err" => new ParkingStgallenError($op . "_allow",
                "ParkingStgallenSDK: " . $op . ": operation not allowed by" .
    ...
    private function raw_request(array $fetchargs = []): mixed
    {
        ...
        if (is_array($fetched)) {
            $status = ParkingStgallenHelpers::to_int(Struct::getprop($fetched, "status"));
    ...
    public function graphql(string $query, ?array $variables = null, ?array $ctrl = null): mixed
    {
        ...
        if (is_array($errors) && 0 < count($errors)) {
            ...
            $res["ok"] = false;
            $res["err"] = new ParkingStgallenError("graphql_error",
                "ParkingStgallenSDK: graphql: " . $msg);
            $res["graphql"] = $errors;
        }
    ...
    public function ParkingRecord($data = null)
    {
        ...
        if ($data === null) {
            if ($this->_parking_record === null) {
                $this->_parking_record = new ParkingRecordEntity($this, null);
            }
            return $this->_parking_record;
        }
        return new ParkingRecordEntity($this, $data);
    }
    ...
    public static function test(?array $testopts = null, ?array $sdkopts = null): self
    {
        ...
        $sdk = new ParkingStgallenSDK($sdkopts);
        $sdk->mode = "test";
        return $sdk;
    }
}
