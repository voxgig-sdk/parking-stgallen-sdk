...
function envOverride(m) {
    if ('TRUE' === process.env.PARKING_STGALLEN_TEST_LIVE ||
        'TRUE' === process.env.PARKING_STGALLEN_TEST_OVERRIDE) {
    ...
    m.PARKING_STGALLEN_TEST_EXPLAIN = process.env.PARKING_STGALLEN_TEST_EXPLAIN || m.PARKING_STGALLEN_TEST_EXPLAIN;
    return m;
}
