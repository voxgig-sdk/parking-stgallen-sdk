...
(0, node_test_1.describe)('ParkingRecordDirect', async () => {
    ...
    (0, node_test_1.test)('direct-exists', async () => {
        const sdk = new __1.ParkingStgallenSDK({
    ...
    (0, node_test_1.test)('direct-load-parking_record', async (t) => {
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-parking_record', setup.live))
            return;
    ...
    (0, node_test_1.test)('direct-list-parking_record', async (t) => {
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-parking_record', setup.live))
            return;
        const { client, calls } = setup;
        const params = {};
        const query = {};
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        const client = new __1.ParkingStgallenSDK(Object.assign({}, (0, utility_1.liveClientOptions)(), {}));
        let idmap = env['PARKING_STGALLEN_TEST_PARKING_RECORD_ENTID'];
    ...
    const client = new __1.ParkingStgallenSDK({
        base: 'http://localhost:8080',
...
//# sourceMappingURL=ParkingRecordDirect.test.js.map