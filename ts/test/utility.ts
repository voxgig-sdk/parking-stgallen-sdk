...
function envOverride(m: Record<string, any>) {
  if (
    'TRUE' === process.env.PARKINGSTGALLEN_TEST_LIVE ||
    'TRUE' === process.env.PARKINGSTGALLEN_TEST_OVERRIDE
  ) {
  ...
  m.PARKINGSTGALLEN_TEST_EXPLAIN = process.env.PARKINGSTGALLEN_TEST_EXPLAIN || m.PARKINGSTGALLEN_TEST_EXPLAIN
