...
The TypeScript SDK for the ParkingStgallen API. Provides a type-safe, entity-oriented interface with full async/await support.
...
```ts
const client = new ParkingStgallenSDK({ apikey: '...' })
