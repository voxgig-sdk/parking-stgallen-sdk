# ParkingStgallen TypeScript SDK



The TypeScript SDK for the ParkingStgallen API — a type-safe, entity-oriented client with full async/await support.

The API is exposed as capitalised, semantic **Entities** — e.g.
`client.ParkingRecord()` — each with a small set of operations (`list`, `load`)
...
```ts
new ParkingStgallenSDK(options?: {
  base?: string
  prefix?: string
  suffix?: string
...
| `tester(testopts?, sdkopts?)` | `ParkingStgallenSDK` | Create a test-mode client instance. |

#### Static methods

| Method | Returns | Description |
| --- | --- | --- |
| `ParkingStgallenSDK.test(testopts?, sdkopts?)` | `ParkingStgallenSDK` | Create a test-mode client. |
...
parking-stgallen/
├── src/
│   ├── ParkingStgallenSDK.ts        # Main SDK class
