...
Allows searching and downloading parking records in Stadt St.Gallen with various parameters.

Learn more about Parking St.Gallen API at [daten.stadt.sg.ch/explore/dataset/freie-parkplatze-in-der-stadt-stgallen-pls/api](https://daten.stadt.sg.ch/explore/dataset/freie-parkplatze-in-der-stadt-stgallen-pls/api/).
...
const items = await client.ParkingRecord().list({ dataset: "example" })
```
...
| Go CLI | `github.com/voxgig-sdk/parking-stgallen-sdk/go-cli` | `go install github.com/voxgig-sdk/parking-stgallen-sdk/go-cli/cmd/parking-stgallen@latest` |
| Go MCP server | `github.com/voxgig-sdk/parking-stgallen-sdk/go-mcp` | `go get github.com/voxgig-sdk/parking-stgallen-sdk/go-mcp@latest` |
