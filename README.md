...
| --- | --- | --- |
| TypeScript | `@voxgig-sdk/parking-stgallen` | `npm install @voxgig-sdk/parking-stgallen` |
| Python | `voxgig-sdk-parking-stgallen` | `pip install voxgig-sdk-parking-stgallen` |
| PHP | `voxgig-sdk/parking-stgallen` | `composer require voxgig-sdk/parking-stgallen` |
| Golang | `github.com/voxgig-sdk/parking-stgallen-sdk/go` | `go get github.com/voxgig-sdk/parking-stgallen-sdk/go` |
| Ruby | `voxgig-sdk-parking-stgallen` | `gem install voxgig-sdk-parking-stgallen` |
| Lua | `voxgig-sdk-parking-stgallen` | `luarocks install voxgig-sdk-parking-stgallen` |
